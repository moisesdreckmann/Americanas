...
<head>
    ...
    <link rel="preload" as="style" href="estilo/estilo.css">
    <link rel="stylesheet" href="estilo/estilo.css" media="all">
    <link rel="stylesheet" href="fonts/css/all.css" media="all">
...
<body class="bodyindex">
    <header class="header">
        ...
        <div class="divLogin">
           <div class="divTextoLogin divTextoSpanName">
           <?php
           require_once("includes/functions.php");
           $array = array($_SESSION['email']);
           $query = "SELECT * FROM pessoas WHERE email = ?";
           $selecao = 0;
           $pegarNome = listagem2($query, $array, $selecao);
           ?>
                <i class="fa-regular fa-circle-user"></i>
                <span>Olá, <?php echo $pegarNome['nome'];?></span>
                <div class="divSub-login">
                    <p>você poderá ver seu perfil e acessar suas informações por aqui :&#41;</p>
                    <a href="perfil.php" target="_self">
                        <button type="click" name="redirecionaLog" class="redirecionaBtnlog" value="redirecionaLog">perfil</button>
                    </a>
                    <form action="includes/logica.php" method="post">
                        <button type="submit" name="logout" class="redirecionaBtncad" value="logout">sair</button>  
                    </form>
                </div>
           </div>
        </div>
